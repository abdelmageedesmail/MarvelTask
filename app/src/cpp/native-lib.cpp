...
JNICALL
Java_com_abdelmageed_marveltask_data_di_RepositoryModule_getPublicKey(
        JNIEnv *env, jobject thiz) {
...
JNICALL
Java_com_abdelmageed_marveltask_data_di_RepositoryModule_getPrivateKey(
        JNIEnv *env, jobject thiz) {
...
JNICALL
Java_com_abdelmageed_marveltask_data_di_KtorModule_getBaseUrl(JNIEnv *env, jobject thiz) {
